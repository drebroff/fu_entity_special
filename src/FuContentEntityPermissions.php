...
use Drupal\fu_entity_special\Entity\FuContentEntity;


/**
 * Provides dynamic permissions for Funamy content entity of different types.
 *
 * @ingroup fu_entity_special
 *
 */
class FuContentEntityPermissions{
   ...
   *
   * @return array
   *   The FuContentEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (FuContentEntity::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\fu_entity_special\Entity\FuContentEntity $type
   *   The FuContentEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(FuContentEntity $type) {
    $type_id = $type->id();
